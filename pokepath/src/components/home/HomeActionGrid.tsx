...
const ACCENT_LINK_CLASS: Record<HomeActionTile['accent'], string> = {
  ...
  red:
    'border-red-200/80 bg-gradient-to-br from-red-50/45 to-white/30 hover:from-red-50/65 hover:to-white/40 dark:border-red-800/40 dark:from-red-950/30 dark:to-zinc-950/25 dark:hover:from-red-950/42 dark:hover:to-zinc-950/35',
  indigo:
    ...
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
      {tiles.map((tile) => (
        <Link
          ...
          href={tile.href}
          className={`block h-full rounded-xl border border-white/50 p-5 shadow-sm backdrop-blur-lg transition-colors dark:border-white/10 ${ACCENT_LINK_CLASS[tile.accent]}`}
        >
