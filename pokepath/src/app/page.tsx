...
export default function Home() {
  return (
    <div className="relative flex min-h-full flex-1 items-center justify-center overflow-hidden bg-gradient-to-b from-amber-50 via-zinc-50 to-emerald-50 px-6 py-12 dark:from-zinc-950 dark:via-black dark:to-zinc-900">
      <HomePokemonBackdrop />
      <div
        className="pointer-events-none absolute inset-0 z-[1] bg-gradient-to-b from-amber-50/90 via-zinc-50/82 to-emerald-50/88 dark:from-zinc-950/92 dark:via-black/78 dark:to-zinc-900/90"
        aria-hidden
      />
